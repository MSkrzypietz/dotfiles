...
hl.on("hyprland.start", function () 
  hl.exec_cmd("waybar")
  hl.exec_cmd("hyprctl dispatch workspace 1") -- focus primary monitor on startup
end)
...
-- No springs and no popIn: springs overshoot (that's the jiggle),
-- and "popin 87%" scales new windows in, which looks bad with 0 gaps.
...
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 2,    bezier = "easeOutQuint" })
...
for i = 1, 10 do
    ...
    hl.workspace_rule({ workspace = key, monitor = "DP-1" })
end
hl.workspace_rule({ workspace = 11, default_name = "Q", monitor = "DP-2" })
hl.workspace_rule({ workspace = 12, default_name = "W", monitor = "DP-2" })
hl.workspace_rule({ workspace = 13, default_name = "E", monitor = "DP-2" })
...
hl.bind(mainMod .. " + F", hl.dsp.exec_cmd("grim -g '$(slurp -d)' - | wl-copy"))
...
hl.bind(mainMod .. " + q",         hl.dsp.focus({ workspace = 11}))
hl.bind(mainMod .. " + SHIFT + q", hl.dsp.window.move({ workspace = 11 }))
hl.bind(mainMod .. " + w",         hl.dsp.focus({ workspace = 12}))
hl.bind(mainMod .. " + SHIFT + w", hl.dsp.window.move({ workspace = 12 }))
hl.bind(mainMod .. " + e",         hl.dsp.focus({ workspace = 13}))
hl.bind(mainMod .. " + SHIFT + e", hl.dsp.window.move({ workspace = 13 }))
...
-- Fix steam to open in tiling mode instead of floating
hl.window_rule({
    name  = "steam-tiling",
    match = { class = "steam" },
